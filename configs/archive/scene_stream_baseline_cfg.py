"""Single-scene baseline: stream scene + standard Mask R-CNN.

Run:
    python main.py --mode train --config scene_stream_baseline --exp_name <name>
    python main.py --mode train --config scene_stream_baseline --exp_name <name> --seed 1
"""
...
@CONFIGS.register_module(name="scene_stream_baseline")
class SceneStreamBaselineConfig:

    # ============================================================
    # 通用
    # ============================================================
    TASK_NAME   = "scene_stream_baseline"
    ...
    PER_SCENE_DIR = os.path.join(BASE_DIR, "dataset", "per_scene", "stream")
